  ...
  return (
    <section className="page fade">
      <Link to="/tasks" className="back-btn">
        <Icon name="chevLeft" />К списку задач
      </Link>
      <div className="detail-grid">
        <Card className="detail-main">
          ...
          <div className="detail-meta">
            <span>
              <Icon name={category.icon as never} />
            ...
            <span>
              ...
              <b style={{ color: taskPriorities[task.priority].color }}>
            ...
            {task.subtasks.map((subtask) => (
              ...
              >
                <Check
                  ...
                  onClick={() =>
                    toggleSubtask({ taskId: task.id, subtaskId: subtask.id })
                  }
                  size={21}
                />
        ...
        <aside className="detail-side">
          <Card className="side-panel">
            ...
            <div className="progress-big">
              <Ring value={progress} size={64} stroke={8} />
          ...
          <Card className="side-panel">
            ...
            <div className="priority-options">
              {Object.entries(taskPriorities).map(([key, item]) => (
                <button
                  key={key}
                  className={task.priority === key ? "on" : ""}
                  onClick={() =>
                    setPriority({ id: task.id, priority: key as TaskPriority })
                  }
                >
                  {item.label}
                </button>
          ...
          <Card className="side-panel">
            ...
            <div className="kv">
              <span>Срок</span>
              <b>
                {formatDateLabel(task.date)}, {task.time}
              </b>
            </div>
            <div className="kv">
              <span>Статус</span>
